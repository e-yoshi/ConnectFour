...
load_background_1:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_2 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_2:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_3 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_3:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_6 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_4:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_5 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_6:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_7 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_7:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_8 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_8:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_9 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_9:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_10 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++
...
load_background_10:
	...
	add $r0, $r0, $r0 #nop before output.
	add $r0, $r0, $r0 #nop before output.
	bne  $r24, $r23, load_background_11 #x!=width=160   else...
	add $r24, $r0, $r0 # $r24= x = 0
	addi $r25, $r25, 1 # y++

load_background_11:
	bne  $r29, $r22, load_background_1
